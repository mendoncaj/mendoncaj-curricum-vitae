...
\familyname{\fontsize{25}{30}\selectfont Mendonca}
\title{Consultor de Software - Especialista Java}

% All information in this block is optional, comment out any lines you don't need
\address{Av. Dr. Orencio Vidigal, 598 Apto. 51, Bl. 5}{Penha - Sao Paulo - SP, CEP 03640-010}
\mobile{+55 (11) 97411-4534}
\email{jdev.mendonca@gmail.com}

%\homepage{linkedin.com/in/mendoncaj}{linkedin.com/in/mendoncaj} % The first argument is the url for the clickable link, the second argument is the url displayed in the template - this allows special characters to be displayed such as the tilde in this example
\quote{"Seja a mudanca que voce deseja para o mundo" - Mahatma Gandhi}
